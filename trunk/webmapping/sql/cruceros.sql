...
-- -----------------------------------------------------
-- Table `cenimarc_`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`users` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`users` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`groups` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`groups` (
  `id` INT(11) NOT NULL DEFAULT '0' ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`metadata`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`metadata` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`metadata` (
  `id` INT(11) NOT NULL DEFAULT '0' ,
  ...
  CONSTRAINT `FKE52D7B2F7172551F`
    ...
    REFERENCES `cenimarc_`.`groups` (`id` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`archivo_datos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`archivo_datos` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`archivo_datos` (
  ...
  CONSTRAINT `FKE8838288C52ADEF9`
    ...
    REFERENCES `cenimarc_`.`metadata` (`id` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`archivo_guardian`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`archivo_guardian` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`archivo_guardian` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_biota_comp_model`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_biota_comp_model` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_biota_comp_model` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_category` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_category` (
  ...
  CONSTRAINT `FK4E53B25150CF1E1A`
    ...
    REFERENCES `cenimarc_`.`inv_discipline` (`id_discipline` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_group` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_group` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_category_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_category_group` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_category_group` (
  ...
  CONSTRAINT `FK7E1C4B11ACA43B2F`
    ...
    REFERENCES `cenimarc_`.`report_group` (`GROUP_ID` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_parameter_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_parameter_group` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_parameter_group` (
  `CODE` VARCHAR(4) NOT NULL DEFAULT '' ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_category_link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_category_link` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_category_link` (
  ...
  CONSTRAINT `FKFBD181289F5AF963`
    ...
    REFERENCES `cenimarc_`.`bodc_parameter_group` (`CODE` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_datasource`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_datasource` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_datasource` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_chart`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_chart` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_chart` (
  ...
  CONSTRAINT `FK377CD913211D3CF1`
    ...
    REFERENCES `cenimarc_`.`report` (`REPORT_ID` ),
  CONSTRAINT `FK377CD9132B065EE5`
    FOREIGN KEY (`DATASOURCE_ID` )
    REFERENCES `cenimarc_`.`report_datasource` (`DATASOURCE_ID` ),
  CONSTRAINT `FK377CD91395C891DE`
    FOREIGN KEY (`OVERLAY_CHART_ID` )
    REFERENCES `cenimarc_`.`report_chart` (`CHART_ID` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_export_options`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_export_options` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_export_options` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report` (
  ...
  CONSTRAINT `FK8FDF4934F4DD5A50`
    ...
    REFERENCES `cenimarc_`.`report_export_options` (`EXPORT_OPTION_ID` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_user` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_user` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_category_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_category_user` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_category_user` (
  `category_code` VARCHAR(4) NOT NULL ,
  ...
  CONSTRAINT `FK_bodc_category_user_2`
    ...
    REFERENCES `cenimarc_`.`report_user` (`REPORTUSER_ID` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;


-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_chem_model`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_chem_model` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_chem_model` (
  `CODE` VARCHAR(8) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_datos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_datos` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_datos` (
  ...
  CONSTRAINT `FK7E934B481A0373AB`
    ...
    REFERENCES `cenimarc_`.`archivo_datos` (`id_archivo` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_detalle_datos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_detalle_datos` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_detalle_datos` (
  ...
  CONSTRAINT `FK9DA9980776F760F`
    ...
    REFERENCES `cenimarc_`.`bodc_datos` (`id` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_itis_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_itis_map` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_itis_map` (
  `CODE` VARCHAR(8) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_units`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_units` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_units` (
  `CODE` VARCHAR(4) NOT NULL DEFAULT '' ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_parameter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_parameter` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_parameter` (
  ...
  CONSTRAINT `FK934C68B649A68DD7`
    ...
    REFERENCES `cenimarc_`.`bodc_units` (`CODE` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`paises_0101`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`paises_0101` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`paises_0101` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`gendepartamento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`gendepartamento` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`gendepartamento` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`gen_municipio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`gen_municipio` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`gen_municipio` (
  ...
  CONSTRAINT `FKB01F3DBEA6C28447`
    FOREIGN KEY (`DEPTO` )
    REFERENCES `cenimarc_`.`gendepartamento` (`Id_Departamento` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`solicitud_parametros`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`solicitud_parametros` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`solicitud_parametros` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_required_parameter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_required_parameter` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_required_parameter` (
  ...
  CONSTRAINT `FKB3AAC89CA0862A47`
    ...
    REFERENCES `cenimarc_`.`solicitud_parametros` (`id_solicitud` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`bodc_titulo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`bodc_titulo` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`bodc_titulo` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`categories`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`categories` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`categories` (
  `id` INT(11) NOT NULL DEFAULT '0' ,
  `name` VARCHAR(32) NOT NULL ,
  PRIMARY KEY (`id`) ,
  UNIQUE INDEX `name` (`name` ASC) )
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`languages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`languages` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`languages` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`categoriesdes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`categoriesdes` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`categoriesdes` (
  ...
  CONSTRAINT `categoriesdes_ibfk_1`
    FOREIGN KEY (`idDes` )
    REFERENCES `cenimarc_`.`categories` (`id` ),
  CONSTRAINT `categoriesdes_ibfk_2`
    FOREIGN KEY (`langId` )
    REFERENCES `cenimarc_`.`languages` (`id` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;


-- -----------------------------------------------------
-- Table `cenimarc_`.`gen_profesion`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`gen_profesion` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`gen_profesion` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`genmunicipio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`genmunicipio` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`genmunicipio` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`groupsdes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`groupsdes` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`groupsdes` (
  `idDes` INT(11) NOT NULL DEFAULT '0' ,
  `langId` VARCHAR(5) NOT NULL DEFAULT '' ,
  `label` VARCHAR(96) NOT NULL ,
  PRIMARY KEY (`idDes`, `langId`) ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`unlocode_status_indicators`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`unlocode_status_indicators` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`unlocode_status_indicators` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`unlocode_port`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`unlocode_port` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`unlocode_port` (
  ...
  CONSTRAINT `FKC95BCD37A416EDA8`
    FOREIGN KEY (`Status` )
    REFERENCES `cenimarc_`.`unlocode_status_indicators` (`STStatus` ),
...
CREATE  TABLE IF NOT EXISTS `cenimarc_`.`inv_ship_name` (
  ...
  `construction_date` DATETIME NULL DEFAULT NULL ,
  `construction_country` CHAR(2) NULL DEFAULT NULL ,
  `reception_date` DATETIME NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`regions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`regions` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`regions` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`inv_report`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`inv_report` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`inv_report` (
...
CREATE  TABLE IF NOT EXISTS `cenimarc_`.`inv_cruise_inventory` (
  ...
  INDEX `fk_inv_cruise_inventory_inv_report1` (`id_report` ASC) ,
  ...
  CONSTRAINT `FK_inv_cruise_inventory_7`
    FOREIGN KEY (`ship_name` )
    REFERENCES `cenimarc_`.`inv_ship_name` (`Id` ),
  CONSTRAINT `fk_inv_cruise_inventory_inv_report1`
    FOREIGN KEY (`id_report` )
    REFERENCES `cenimarc_`.`inv_report` (`id_report` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`isolanguages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`isolanguages` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`isolanguages` (
  `id` INT(11) NOT NULL DEFAULT '0' ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`isolanguagesdes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`isolanguagesdes` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`isolanguagesdes` (
  `idDes` INT(11) NOT NULL DEFAULT '0' ,
  `langId` VARCHAR(5) NOT NULL DEFAULT '' ,
  `label` VARCHAR(96) NOT NULL ,
  PRIMARY KEY (`idDes`, `langId`) ,
  ...
  CONSTRAINT `isolanguagesdes_ibfk_1`
    FOREIGN KEY (`idDes` )
    REFERENCES `cenimarc_`.`isolanguages` (`id` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`malla_datos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`malla_datos` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`malla_datos` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`metadatacateg`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`metadatacateg` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`metadatacateg` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`metadatarating`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`metadatarating` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`metadatarating` (
  `metadataId` INT(11) NOT NULL DEFAULT '0' ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`metadatos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`metadatos` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`metadatos` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`observacion_datos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`observacion_datos` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`observacion_datos` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`operations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`operations` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`operations` (
  `id` INT(11) NOT NULL DEFAULT '0' ,
  `name` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`operationallowed`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`operationallowed` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`operationallowed` (
  ...
  CONSTRAINT `operationallowed_ibfk_3`
    ...
    REFERENCES `cenimarc_`.`operations` (`id` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;


-- -----------------------------------------------------
-- Table `cenimarc_`.`operationsdes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`operationsdes` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`operationsdes` (
  `idDes` INT(11) NOT NULL DEFAULT '0' ,
  `langId` VARCHAR(5) NOT NULL DEFAULT '' ,
  `label` VARCHAR(96) NOT NULL ,
  PRIMARY KEY (`idDes`, `langId`) ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`or_properties`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`or_properties` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`or_properties` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`or_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`or_tags` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`or_tags` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`profundidades_estandar`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`profundidades_estandar` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`profundidades_estandar` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_job_details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_job_details` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_job_details` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_triggers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_triggers` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_triggers` (
  ...
  CONSTRAINT `qrtz_triggers_ibfk_1`
    ...
    REFERENCES `cenimarc_`.`qrtz_job_details` (`JOB_NAME` , `JOB_GROUP` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;


-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_blob_triggers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_blob_triggers` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_blob_triggers` (
  `TRIGGER_NAME` VARCHAR(80) NOT NULL ,
  `TRIGGER_GROUP` VARCHAR(80) NOT NULL ,
  ...
  CONSTRAINT `qrtz_blob_triggers_ibfk_1`
    ...
    REFERENCES `cenimarc_`.`qrtz_triggers` (`TRIGGER_NAME` , `TRIGGER_GROUP` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;


-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_calendars`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_calendars` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_calendars` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_cron_triggers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_cron_triggers` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_cron_triggers` (
  `TRIGGER_NAME` VARCHAR(80) NOT NULL ,
  `TRIGGER_GROUP` VARCHAR(80) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_fired_triggers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_fired_triggers` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_fired_triggers` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_job_listeners`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_job_listeners` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_job_listeners` (
  `JOB_NAME` VARCHAR(80) NOT NULL ,
  `JOB_GROUP` VARCHAR(80) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_locks`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_locks` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_locks` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_paused_trigger_grps`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_paused_trigger_grps` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_paused_trigger_grps` (
  `TRIGGER_GROUP` VARCHAR(80) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_scheduler_state`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_scheduler_state` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_scheduler_state` (
  `INSTANCE_NAME` VARCHAR(80) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_simple_triggers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_simple_triggers` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_simple_triggers` (
  `TRIGGER_NAME` VARCHAR(80) NOT NULL ,
  `TRIGGER_GROUP` VARCHAR(80) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`qrtz_trigger_listeners`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`qrtz_trigger_listeners` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`qrtz_trigger_listeners` (
  `TRIGGER_NAME` VARCHAR(80) NOT NULL ,
  `TRIGGER_GROUP` VARCHAR(80) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`regionsdes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`regionsdes` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`regionsdes` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`relations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`relations` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`relations` (
  `id` INT(11) NOT NULL DEFAULT '0' ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_alert`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_alert` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_alert` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_log` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_log` (
  ...
  CONSTRAINT `FK901BE59920DA4A2D`
    ...
    REFERENCES `cenimarc_`.`report_alert` (`ALERT_ID` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_delivery_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_delivery_log` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_delivery_log` (
  ...
  CONSTRAINT `FKC783FD84632801ED`
    FOREIGN KEY (`LOG_ID` )
    REFERENCES `cenimarc_`.`report_log` (`LOG_ID` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;


-- -----------------------------------------------------
-- Table `cenimarc_`.`report_group_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_group_map` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_group_map` (
  `GROUP_ID` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_parameter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_parameter` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_parameter` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`report_parameter_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`report_parameter_map` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`report_parameter_map` (
  `REPORT_ID` INT(11) NOT NULL ,
  ...
  CONSTRAINT `FK23FF1FBB1AFAD98D`
    ...
    REFERENCES `cenimarc_`.`report_parameter` (`PARAMETER_ID` ),
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`settings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`settings` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`settings` (
  `id` INT(11) NOT NULL DEFAULT '0' ,
  ...
  CONSTRAINT `settings_ibfk_1`
    ...
    REFERENCES `cenimarc_`.`settings` (`id` ))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;


-- -----------------------------------------------------
-- Table `cenimarc_`.`sources`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`sources` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`sources` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`user_alert_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`user_alert_map` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`user_alert_map` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`user_group_map`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`user_group_map` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`user_group_map` (
  `USER_ID` INT(11) NOT NULL ,
  `GROUP_ID` INT(11) NOT NULL ,
  `MAP_ID` INT(11) NOT NULL ,
  PRIMARY KEY (`USER_ID`, `MAP_ID`) ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`user_security`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`user_security` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`user_security` (
  `USER_ID` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`usergroups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`usergroups` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`usergroups` (
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`usuario_datos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`usuario_datos` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`usuario_datos` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`inv_cruise_metadata`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`inv_cruise_metadata` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`inv_cruise_metadata` (
  `id_cruise` INT NOT NULL ,
  `id_metadata` INT NOT NULL ,
  PRIMARY KEY (`id_cruise`, `id_metadata`) ,
  INDEX `fk_inv_cruise_inventory_has_inv_metadata_inv_metadata1` (`id_metadata` ASC) ,
  INDEX `fk_inv_cruise_inventory_has_inv_metadata_inv_cruise_inventory1` (`id_cruise` ASC) ,
  CONSTRAINT `fk_inv_cruise_inventory_has_inv_metadata_inv_cruise_inventory1`
    FOREIGN KEY (`id_cruise` )
    REFERENCES `cenimarc_`.`inv_cruise_inventory` (`id_cruise` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inv_cruise_inventory_has_inv_metadata_inv_metadata1`
    FOREIGN KEY (`id_metadata` )
    REFERENCES `cenimarc_`.`inv_metadata` (`id_metadata` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `cenimarc_`.`inv_cruise_to_project`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cenimarc_`.`inv_cruise_to_project` ;

CREATE  TABLE IF NOT EXISTS `cenimarc_`.`inv_cruise_to_project` (
  `inv_project_id_project` INT(10) UNSIGNED NOT NULL ,
  `inv_cruise_inventory_id_cruise` INT NOT NULL ,
  PRIMARY KEY (`inv_project_id_project`, `inv_cruise_inventory_id_cruise`) ,
  INDEX `fk_inv_project_has_inv_cruise_inventory_inv_cruise_inventory1` (`inv_cruise_inventory_id_cruise` ASC) ,
  INDEX `fk_inv_project_has_inv_cruise_inventory_inv_project1` (`inv_project_id_project` ASC) ,
  CONSTRAINT `fk_inv_project_has_inv_cruise_inventory_inv_project1`
    FOREIGN KEY (`inv_project_id_project` )
    REFERENCES `cenimarc_`.`inv_project` (`id_project` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inv_project_has_inv_cruise_inventory_inv_cruise_inventory1`
    FOREIGN KEY (`inv_cruise_inventory_id_cruise` )
    REFERENCES `cenimarc_`.`inv_cruise_inventory` (`id_cruise` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
